...
![gptcommit](https://repo.x-cmd.io/gptcommit.svg)
...
Total: **1,763** lines of code across **39** files in the top 5 languages.
...
- **Stars**: 2,419 · **Forks**: 81 · **Open issues**: 68 · **Contributors**: 11

## Totals (cumulative)

- **Releases**: 36 · **Merged PRs**: 135 · **Open PRs**: 11 · **Closed issues**: 60 · **Open issues**: 8 · **Commits**: 320
...
Reported by **8** distros on [repology.org](https://repology.org/project/gptcommit). **5** are ✅ on the latest upstream release, **2** are ⚠️ on an older version.
...
_Snapshot: `data/card/260910.yml` · 2026-09-10T20:09:10Z._
